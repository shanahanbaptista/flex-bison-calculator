...
#define TOK_SUB 259
#define TOK_MUL 260
#define TOK_PRINTID 261
#define TOK_PRINTEXP 262
#define TOK_MAIN 263
#define TOK_LB 264
#define TOK_RB 265
#define TOK_ASSIGN 266
#define TOK_ID 267
#define TOK_TYPEINT 268
#define TOK_TYPEFLOAT 269
#define INT 270
#define FLOAT 271
...
{
       0,     0,     3,     4,    10,    11,    15,    18,    21,    22,
      26,    30,    33,    36,    37,    39,    41,    43,    47,    51
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      18,     0,    -1,    -1,     8,     9,    19,    21,    10,    -1,
      -1,    20,     3,    19,    -1,    13,    12,    -1,    14,    12,
      -1,    -1,    22,     3,    21,    -1,    12,    11,    23,    -1,
       6,    12,    -1,     7,    23,    -1,    -1,    15,    -1,    16,
      -1,    12,    -1,    23,     5,    23,    -1,    23,     4,    23,
      -1,    -1
};
...
static const char *const yytname[] =
{
  ...
  "TOK_PRINTID", "TOK_PRINTEXP", "TOK_MAIN", "TOK_LB", "TOK_RB",
  "TOK_ASSIGN", "TOK_ID", "TOK_TYPEINT", "TOK_TYPEFLOAT", "INT", "FLOAT",
  "$accept", "Prog", "Vardefs", "Vardef", "Stmts", "Stmt", "expr", 0
};
#endif
...
{
       2,     0,     0,     4,     1,     0,     0,     8,     0,     6,
       7,     0,    19,     0,     0,     0,     4,    11,    16,    14,
      15,    12,    19,     3,     8,     5,    19,    19,    10,     9,
      18,    17
};
...
{
      -6,     7,     8,    -1,   -22,     5,     6,    -3,    16,   -22,
     -22,     9,    -5,    11,    13,    17,    -1,   -22,   -22,   -22,
     -22,    10,    -5,   -22,    -3,   -22,    -5,    -5,    10,   -22,
      19,   -22
};
...
{
     -13,    28,     1,    11,    12,    30,    31,    18,     4,    13,
      19,    20,     5,     6,    26,    27,     3,     9,    10,    16,
      24,    17,    22,    23,    27,    29,     0,     0,    25
};

static const yytype_int8 yycheck[] =
{
       3,    22,     8,     6,     7,    26,    27,    12,     0,    12,
      15,    16,    13,    14,     4,     5,     9,    12,    12,     3,
       3,    12,    11,    10,     5,    24,    -1,    -1,    16
};
...
{
       0,     8,    18,     9,     0,    13,    14,    19,    20,    12,
      12,     6,     7,    12,    21,    22,     3,    12,    12,    15,
      16,    23,    11,    10,     3,    19,     4,     5,    23,    21,
      23,    23
};
